    ...
    return (
        <div className='dashboard-left mt-32 h-fit flex flex-col items-center justify-center'>
            ...
            <ul className='mt-14  flex flex-col items-start'>
                <li><button onClick={() => handleTabs(0)} className={` text-base mb-4  flex items-center justify-center w-48     rounded-full ${tabs === 0 ? "h-20 border-2px border-solid border-accent-color text-accent-color bg-none hover:bg-none hover:text-accent-color" : "h-16 border-none text-white bg-slate-600/20 hover:bg-slate-600/30 hover:text-button-main-light"}`}><FiHome className='text-lg mr-2 ' />Dashboard</button></li>
                <li><button onClick={() => handleTabs(1)} className={` text-base mb-4  flex items-center justify-center w-48     rounded-full ${tabs === 1 ? "h-20 border-2px border-solid border-accent-color text-accent-color bg-none hover:bg-none hover:text-accent-color" : "h-16 border-none text-white bg-slate-600/20 hover:bg-slate-600/30 hover:text-button-main-light"}`}><FiX className='text-lg mr-2' />Closed Bugs</button></li>
                <li><button onClick={() => handleTabs(2)} className={` text-base mb-4  flex items-center justify-center w-48     rounded-full ${tabs === 2 ? "h-20 border-2px border-solid border-accent-color text-accent-color bg-none hover:bg-none hover:text-accent-color" : "h-16 border-none text-white bg-slate-600/20 hover:bg-slate-600/30 hover:text-button-main-light"}`}><FiUser className='text-lg mr-2' />Profile</button></li>
            </ul>
        </div>
    )
}
